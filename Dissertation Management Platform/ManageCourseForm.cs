...
namespace TexnologiaLogismikou
{
    public partial class ManageCourseForm : Form
    {
        ...
        {
            //show course list on datagridview table
        ...
        {
            if (textBox_Cname.Text == "" || textBox_Chour.Text == "" || textBox_id.Text.Equals("")) //all should be filled to add course successfully
            {
            ...
            else
            {
                ...
                if (course.updateCourse(id, cName, chr, desc))
                {
                    ...
                    MessageBox.Show("H Πτυχιακή Εργασία επικαιροποιήθηκε!", "Επικαιροποίηση Πτυχιακής", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                else
                {
                    MessageBox.Show("Σφάλμα. Δεν επικαιροποιήθηκε η Πτυχιακή Εργασία.", "Επικαιροποίηση Πτυχιακής", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Χρειάζεται το ID της Πτυχιακής Εργασίας", "Σφάλμα", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                try
                {
                    ...
                    if (course.deleteCourse(id))
                    {
                        showData();
                        button_clear.PerformClick();
                        MessageBox.Show("H Πτυχιακή Εργασία διαγράφηκε.", "Διαγραφή Πτυχιακής", MessageBoxButtons.OK, MessageBoxIcon.Information);

                    }
                }catch (Exception ex)
                {
                    MessageBox.Show(ex.Message, "Διαγραφή Πτυχιακής", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        {
            //search course and show on datagridview table
